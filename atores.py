...
class Passaro(Ator):
    ...
    def calcular_posicao(self, tempo):
        ...
        if self._esta_voando():
            ...
            self._calcular_posiciao_vertical(delta_t)
            self._calcular_posiciao_horizontal(delta_t)
    ...
    def _calcular_posiciao_vertical(self, delta_t):
    ...
    def _calcular_posiciao_horizontal(self, delta_t):
